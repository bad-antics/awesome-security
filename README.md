...
- [GlowBarn](https://github.com/bad-antics/glowbarn-rs) - High-performance multi-sensor anomaly detection suite written in Rust. Features 50+ sensor types, entropy analysis, Bayesian fusion, and AES-256-GCM encryption for environmental monitoring and research.
