...
- [n01d Machine](https://github.com/bad-antics/n01d-machine) - Secure cross-platform virtual machine manager with built-in sandboxing, Tor routing, VPN support (WireGuard/OpenVPN), network isolation modes, and security profiles (Paranoid, Stealth, Isolated, Pentesting) for secure VM deployment.
