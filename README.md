...
- [NullSec Linux](https://github.com/bad-antics/nullsec-linux) - A Debian-based penetration testing distribution optimized for Raspberry Pi and x86 systems with AI-assisted tools and Flipper Zero integration.
