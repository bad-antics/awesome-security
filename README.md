...
- [NullSec Linux](https://github.com/bad-antics/nullsec-linux) - Security-focused Debian-based distribution (v5.0) with 140+ penetration testing tools, featuring Cloud, AI/ML, Automotive, Mobile, and Hardware hacking editions.
